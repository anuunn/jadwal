...
<div class="container-fluid">
    ...
    <marquee direction="up" width="100%" scrollamount="25" height="900px" style="margin-top: 140px; ">
        <div class="row">
            <?php
            if (isset($data[1])) {
                        ...
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-md-3" style="background-position:center; background-size:cover; width:240px !important; height:350px; border-radius: 10%; margin-left: 5px; margin-right:20px">
                                    <?php
                                    if ($value[2] == null) {
                                        echo "<img src='http://localhost/dokter/web/images/doktor.jpg' style='background-position:center; background-size:cover; width:260px !important; height:350px; border-radius: 10%; margin-right:20px>'";
                                    } ?>
